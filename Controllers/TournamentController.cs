...
namespace PubgTournament.Controllers
{
    ...
    {
        private readonly IStore<Tournament> _store;
        [JsonConstructorAttribute]
        public TournamentController(IStore<Tournament> store)
        {
            _store = store;
        }
        // [Authorize]
        ...
        [HttpPost]
        [Route("update")]
        public async Task<IActionResult> UpdateAsync(Tournament model)
        {
